        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="edit-data-penggajian.php">Edit</a>
            </li>
              <li class="breadcrumb-item">
              <a href="edit-gaji-pokok.php">Data Gaji Pokok</a>
            </li>
          ...
          <!-- Form Input -->
            <?php
                include "koneksi.php";
                $id_gajipokok = $_GET['id'];
                
                $query = "SELECT
                          gaji_pokok.id_gajipokok,
                          gaji_pokok.lama_kerja,
                          gaji_pokok.gaji
                          FROM gaji_pokok WHERE id_gajipokok = '$id_gajipokok'";
                ...
                {
            ?>
            <form role="form" action="proses-edit-gaji-pokok.php" method="post" enctype="multipart/form-data">
                <div class="form-group has-success">
                    <label class="control-label" for="inputNIP">ID</label>
                    <input type="text" class="form-control" name="id_gajipokok" value="<?php echo $data['id_gajipokok'] ?>" readonly>
                </div>
                <div class="form-group has-success">
                    <label class="control-label" for="inputNIP">Lama Kerja</label>
                    <input type="text" class="form-control" name="lama_kerja" value="<?php echo $data['lama_kerja'] ?>">
                </div>
                <div class="form-group has-warning">
                    <label class="control-label" for="inputnama">Gaji</label>
