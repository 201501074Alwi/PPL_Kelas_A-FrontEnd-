        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              ...
              <li class="breadcrumb-item">
              <a href="data-penggajian.php">Data Penggajian</a>
            </li>
                  ...
                  <tbody>
                    <?php
                        ...
                        $query = "SELECT
                                  penggajian.nip,
                                  pegawai.nama,
                                  bulan.keterangan_bulan,
                                  gaji_pokok.gaji,
                                  penggajian.tunjangan,
                                  penggajian.bonus,
                                  penggajian.potongan
                                  FROM penggajian
                                  INNER JOIN pegawai ON penggajian.nip = pegawai.nip
                                  INNER JOIN bulan ON penggajian.id_bulan = bulan.id_bulan
                                  INNER JOIN gaji_pokok ON penggajian.id_gajipokok = gaji_pokok.id_gaji_pokok";
                    ...
                    ?>
                            <tr>
                                <td><?=$data['nip']?></td>
                                <td><?=$data['nama']?></td>
                                <td><?=$data['keterangan_bulan']?></td>
                                <td><?=$data['gaji']?></td>
                                <td><?=$data['tunjangan']?></td>
                                <td><?=$data['bonus']?></td>
                                <td><?=$data['potongan']?></td>
                                <td>
                                    <a href="cetak-data-penggajian.php" target="_blank" class="tooltip-error" data-rel="tooltip" title="Print">
