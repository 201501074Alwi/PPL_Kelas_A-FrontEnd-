...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="dashboard-kc.php">CV Otim</a>
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="dashboard-kc.php">Dashboard</a>
            </li>
          ...
          <div class="card mb-3">
            <div class="card-header">
              ...
              Data Presensi
              <span id="dates">
                <span id="the-day">Hari, 00 Bulan 0000</span>
                <span id="the-time">00:00:00</span>
              </span></div>
            <div class="card-body">
