        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="input-data-penggajian.php">Input Data Penggajian</a>
            </li>
                  ...
                  <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a href="form-input-penggajian.php?id=<?php echo $data['nip']; ?>" class="tooltip-error" data-rel="tooltip" title="Input">
